...
// @Param	body		body 	requests.AddClientRequest	true		"body for Clients content"
// @Success 201 {int} models.Clients
// @Failure 403 body is empty
// @router / [post]
func (c *ClientsController) Post() {
	var v requests.AddClientRequest
	json.Unmarshal(c.Ctx.Input.RequestBody, &v)

	var p models.Clients = models.Clients{ClientName: v.ClientName, ClientCode: v.ClientCode, CreatedBy: v.CreatedBy, ModifiedBy: v.ModifiedBy}
	if _, err := models.AddClients(&p); err == nil {
...
func (c *ClientsController) GetAll() {
	...
	if v := c.GetString("query"); v != "" {
		...
		v = strings.TrimSpace(v) + ",Active:1"
